...
namespace PocoPanel.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220304205125_tblProvider-instatell")]
    partial class tblProviderinstatell
    {
            ...
            modelBuilder.Entity("PocoPanel.Domain.Entities.tblProvider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DocumentAddress = "https://instatell.ir/api/v1",
                            Email = "09904955342",
                            Password = "Pouyapouya800",
                            ProviderCredit = 0m,
                            ProviderToken = "UjXn0H3iBwdj7q9T1P7UiMaB0d6RxsX5",
                            Url = "https://instatell.ir/api/v1"
                        });
                });

            modelBuilder.Entity("PocoPanel.Domain.Entities.tblQuality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PocoPanel.Domain.Entities.tblProduct", b =>
                {
                    ...
                    b.HasOne("PocoPanel.Domain.Entities.tblQuality", "tblQuality")
                        .WithMany("TblProduct")
                        .HasForeignKey("tblQualityId");
                });
